    ...
    private void addOffre(ActionEvent event) {
        if((tfIdUserV.getText().equals("")) || (tfDestinationV.getText().equals(""))||(tfDateDepV.toString().equals(""))){
            ...
            alert.showAndWait();
             ...
             try {
           Voyage v = new Voyage();
        v.setOffre_id(Integer.valueOf(tfIdOffreV.getText()));
        ...
        v.setDone(Boolean.valueOf(cbDoneV.getText()));
...
//       v.setOffre_id(idO);
    ...
    private void updateOffre(ActionEvent event) {
        try{
            ...
            selecteditem.setDone(Boolean.valueOf(cbDoneV.getText()));
